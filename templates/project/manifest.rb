...
if Compass.configuration.project_type == :rails
  ...
  javascript 'javascripts/jquery-1.11.3.min.js', :to => 'vendor/jquery.min.js'
  javascript 'javascripts/modernizr-2.8.3.min.js', :to => 'vendor/modernizr.min.js'
  javascript 'javascripts/plugins.js', :to => 'plugins.js'
  javascript 'javascripts/rails.js', :to => 'rails.js'
else
  html 'index.html.haml'
  file 'index.html.haml'
  javascript 'javascripts/jquery-1.11.3.min.js', :to => 'vendor/jquery-1.11.3.min.js'
  javascript 'javascripts/modernizr-2.8.3.min.js', :to => 'vendor/modernizr-2.8.3.min.js'
  javascript 'javascripts/plugins.js', :to => 'plugins.js'
